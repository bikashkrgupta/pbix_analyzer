...
if uploaded_file:
    ...
    all_used_columns = set(direct_columns)
    ...
    indirect_columns = all_used_columns - direct_columns
    ...
    c3.metric("Used Tables", len(all_tables) - len(unused_tables))
